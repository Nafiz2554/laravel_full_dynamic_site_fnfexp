    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                ...
                <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Testimonial's Information</h2>

            </div>
            
            
            <div class="box-content">
                <form class="form-horizontal" action="{{url('/testimonials/')}}" method="post" enctype="multipart/form-data">
                     @csrf
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="date01">Heading</label>
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="heading" required>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="client_address" required>
                            </div>
                        </div> 
